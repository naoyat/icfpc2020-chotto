...
template <typename T1, typename T2> ostream& operator<<(ostream &s, unordered_map<T1,T2> m)
{
  s << "{ ";
  for (auto it=m.begin(); it!=m.end(); it++) {
	if (it != m.begin()) s << ", ";
...
template <typename T1, typename T2> ostream& operator<<(ostream &s, multimap<T1,T2> m)
{
  s << "{ ";
  for (auto it=m.begin(); it!=m.end(); it++) {
	if (it != m.begin()) s << ", ";
...
template <typename T> ostream& operator<<(ostream &s, unordered_set<T> st)
{
  s << "[ ";
  for (auto it=st.begin(); it!=st.end(); it++) {
	if (it != st.begin()) s << ", ";
